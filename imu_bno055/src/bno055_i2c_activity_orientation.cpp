...
bool BNO055I2CActivity::spinOnce() {
    ...
    imu_bno055::orientation msg_orientation;
    msg_orientation.header.stamp = time;
    msg_orientation.header.frame_id = param_frame_id;
    msg_orientation.yaw = (double) record.fused_heading / 16.0;
